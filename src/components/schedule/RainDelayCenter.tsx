                ...
                {DISRUPTION_REASONS.map(rk => (
                  <button key={rk} type="button" onClick={() => setReason(rk)}
                    className={cn('text-xs font-medium rounded-full px-2.5 py-1 border transition-colors',
                      reason === rk ? 'border-accent bg-accent/15 text-accent-text' : 'border-border text-ink-muted hover:text-ink')}>
              ...
              <>
                ...
                <div className="rounded-xl border border-border overflow-hidden">
                  <div className="px-3 py-2 flex items-center justify-between bg-bg-tertiary border-b border-border">
                    ...
                    <div className="flex items-center gap-2 text-[11px] font-medium">
                      <button type="button" onClick={() => setSelectedJobIds(new Set(movable.map(j => j.id)))} className="text-accent-text hover:underline">All</button>
                      <span className="text-ink-faint">·</span>
                      <button type="button" onClick={() => setSelectedJobIds(new Set())} className="text-accent-text hover:underline">None</button>
                    </div>
                  </div>
                ...
                <div className="rounded-xl border border-border overflow-hidden">
                  <label className="px-3 py-2.5 flex items-center gap-2.5 bg-bg-tertiary border-b border-border cursor-pointer">
                    ...
                    <span className="text-xs font-semibold text-ink flex items-center gap-1.5"><MessageSquare className="w-3.5 h-3.5 text-accent-text" /> Notify customers automatically</span>
