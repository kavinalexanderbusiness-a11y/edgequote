...
function readmeText(input: {
  ...
  L.push('  quotes.total          The quote total as stored. It already includes any')
  L.push('                        optional extras the customer took.')
  L.push('  quotes.addons_total   The part of that total which came from optional')
  L.push('                        extras. Extras that were offered and NOT taken are')
  L.push('                        in quote-addons.csv with is_selected false, and are')
  L.push('                        in no total anywhere.')
