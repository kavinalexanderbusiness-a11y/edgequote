...
function readmeText(input: {
  ...
  L.push('  quotes.addons_total   The optional extras the customer added before')
  L.push('                        approving (quote-addons.csv, is_selected = true).')
  L.push('                        It is ALREADY INSIDE quotes.total — do not add it')
  L.push('                        again. Extras agreed after approval are change')
  L.push('                        orders, not these.')
  L.push('')
