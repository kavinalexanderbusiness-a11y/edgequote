...
export const CAMPAIGN_DEFS: CampaignDef[] = [
  ...
  { kind: 'referral',   label: 'Referral Drive',    icon: Gift,        description: 'Ask happy customers to refer a neighbour — word-of-mouth growth.',          anchorMode: 'themed', defaultChannels: LOCAL_FIRST, season: null, defaultName: 'Refer a Neighbour' },
...
export function campaignDirective(kind: CampaignKind, voice: BrandVoice, opts?: { holiday?: string | null }): string {
  ...
  switch (kind) {
    ...
    case 'referral': return `This is a REFERRAL ASK. Thank existing customers and invite them to refer a neighbour. Friendly and low-pressure. Do not promise a specific reward unless told one.`
