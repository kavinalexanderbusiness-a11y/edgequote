  ...
  return (
    <div className="relative overflow-hidden border-b border-border" style={{ height: ROW_H }}>
      ...
      <div
        ...
        className={cn('relative bg-bg-secondary w-full text-left px-4 flex items-center gap-3 cursor-pointer hover:bg-surface/40 transition-colors', selected && 'bg-accent/5', checked && 'bg-accent/10')}
      >
