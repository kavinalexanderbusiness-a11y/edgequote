...
export default async function DashboardPage() {
  ...
  return (
    <PageContainer width="wide">
      ...
      <div className="animate-rise stagger-2"><WeatherStrip report={d.weather} /></div>

      {/* WHAT DO I DO — the one ranked queue (leads, money, follow-ups, at-risk). */}
      <div className="animate-rise stagger-3"><TodaysPriorities items={d.priorities} /></div>

      {/* Today's stops, then the days ahead. */}
      <div className="animate-rise stagger-4"><WeekendOutlook plan={d.dayPlan} /></div>

      {/* How the business is doing — the slow-moving half, last. */}
      <div className="animate-rise stagger-5"><DashboardKpis {...d.kpis} /></div>
    </PageContainer>
  )
}
