-- ── Portal: let the customer see when a quote's price stopped standing ───────
--
-- WHY
...
--
-- WHAT CHANGES
-- Exactly one line: `qt.valid_until` is added to the quotes projection. No column
-- is created (quotes.valid_until already exists — nullable date), no data is
-- backfilled, no status is rewritten, and nothing else in the payload moves.
--
-- SAFETY
