...
--
--   version : 20260715232802
--   name    : service_units_vocabulary
--
...
-- A quote line has ALWAYS been quantity x unit_price (see lib/quoteServices
...
--
-- A unit is a LABEL + a formatting rule. It never enters the arithmetic — that
-- is what makes this safe to add: no total, anywhere, changes.
--
...
-- resolves against this row instead of dangling.
