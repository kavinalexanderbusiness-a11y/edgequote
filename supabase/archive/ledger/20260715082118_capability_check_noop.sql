...
--
--   version : 20260715082118
--   name    : capability_check_noop
--
...
-- Capability probe ONLY: re-sets an existing comment to its exact current value.
-- No schema, data, or behaviour change either way.
