...
--
--   version : 20260811074801
--   name    : portal_data_completion_summary_replaces_internal_notes
--
...
begin
  ...
  select json_build_object(
    ...
    -- notes is DELIBERATELY ABSENT: it is the internal access note and was being
    -- rendered to customers. completion_summary is the customer-visible field.
