...
--
--   version : 20260814041525
--   name    : work_sessions_restore_after_mutation_test
--
...
-- Restores bank_job_clock_session to the shipped definition after the guard's
-- mutation test (the clamp was removed to prove verify:work-sessions catches it).
