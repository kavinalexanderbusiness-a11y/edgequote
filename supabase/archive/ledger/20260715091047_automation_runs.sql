...
--
-- Depends on automation_signals. Safe to run more than once.
...
-- Owners read their own run log (the Automation Center). Writes are service-role
-- only: the engine is the single writer, so nothing else can claim an automation ran.
