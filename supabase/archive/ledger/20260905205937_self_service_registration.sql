...
--
--   version : 20260905205937
--   name    : self_service_registration
--
-- Recovered 2026-09-05 from supabase_migrations.schema_migrations — the SQL
-- production actually executed, not a repo file believed to match it.
--
-- NOT yet folded into supabase/migrations/*_baseline.sql: the active copy still
-- lives in supabase/migrations/20260905205937_self_service_registration.sql and
-- stays in the apply path until the next baseline regeneration. This copy exists
-- so the ledger row has its file and its md5 can be checked, and for nothing
-- else. Re-running one replaces a live object with an older body — silently.
-- ═══════════════════════════════════════
