...
--
--   version : 20260715075546
--   name    : portal_quote_expiry_get_portal_data
--
...
-- Newest in the get_portal_data chain. A proper SUPERSET of the live 07-09
-- etransfer version: retains etransfer_email, nested quote_services and the
-- discount fields, and adds qt.valid_until so the portal can show quote expiry.
-- NEVER re-run an older file in this chain afterward — it would silently roll
-- the portal backward.
