...
create table if not exists public.auto_mowing_quote_rule_versions (
  ...
  pricing_config_version_id uuid not null,
...
alter table public.pricing_config_versions
  add constraint pricing_config_versions_user_id_id_key unique (user_id, id);
alter table public.auto_mowing_quote_rule_versions
  add constraint auto_mowing_quote_rules_pricing_same_owner
  foreign key (user_id, pricing_config_version_id)
  references public.pricing_config_versions(user_id, id);
